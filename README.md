...
[![tag](https://img.shields.io/badge/tag-v0.5.18-purple)](https://github.com/dev-cetera/df_localization/tree/v0.5.18)
...
Please refer to the [API reference](https://pub.dev/documentation/df_localization/) for more information.
